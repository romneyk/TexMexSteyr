...
import heroTexMex from '../assets/hero-texmex.jpg';
import heroCitybar from '../assets/hero-citybar.jpg';
  ...
  return (
    <div className="relative h-screen bg-texmex-black overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <img
          key={currentBrand}
          src={isTexMex ? heroTexMex : heroCitybar}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-8 flex flex-col items-center justify-center h-full">
        ...
        <div className="flex flex-col sm:flex-row gap-8 justify-center items-center w-full mt-4">
          <button
            ...
            className={`group relative px-10 py-6 text-xl font-bold uppercase tracking-wider overflow-hidden transition-all duration-300 shadow-[0_4px_30px_rgba(0,0,0,0.6)] w-80 md:w-96 transform hover:scale-105 ${isTexMex
